      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-10 text-lg text-muted-foreground text-balance md:text-xl max-w-2xl mx-auto leading-relaxed">
            Generate tailored resumes and cover letters designed to pass AI recruiter filters. Track all your
            applications in one organized dashboard.
          </p>
          ...
          <div className="mt-16 rounded-xl border border-border bg-card p-2 shadow-2xl">
            <div className="aspect-video rounded-lg bg-secondary overflow-hidden">
              <img src="/modern-dashboard-showing-ai-generated-resume-and-c.jpg" alt="ApplyMate Dashboard" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </div>
