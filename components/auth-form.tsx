  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Welcome to ApplyMate</h1>
        <p className="text-muted-foreground">Sign in to start creating AI-powered job applications</p>
      </div>
      ...
      <div className="text-center space-y-2">
        <p className="text-sm text-muted-foreground">Start with 3 free applications. No credit card required.</p>
      </div>

      {/* Mobile-only branding link */}
